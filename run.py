...
if __name__ == "__main__":
    ...
    grid_reservoir = [0.6, 0.7, 0.8]
    grid_cushion = [0.9, 1.0, 1.1]
    grid_latency = [3.3, 3.4, 3.5]
    ...
    print(f"max result : ({testcases[max_i][0][3]}, {testcases[max_i][0][4]}, {testcases[max_i][0][5]}), {np.mean(results[max_i],axis = 0)}")
